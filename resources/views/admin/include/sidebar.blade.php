<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link" href="{{ config('admin.path').'/' }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ config('admin.path').'/pages' }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ config('admin.path').'/users' }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ config('admin.path').'/menu' }}">
